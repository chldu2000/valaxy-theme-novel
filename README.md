...
[![npm](https://img.shields.io/npm/v/valaxy-theme-novel)](https://www.npmjs.com/package/valaxy-theme-novel)
[![npm dev dependency version](https://img.shields.io/npm/dependency-version/valaxy-theme-novel/dev/valaxy)](https://github.com/YunYouJun/valaxy)
...
```bash
npx degit YunYouJun/valaxy-theme-novel valaxy-theme-name
...
- [ ] Rename `valaxy-theme-novel` to `valaxy-theme-<name>` (custom it)
...
Rename `valaxy-theme-novel` with `valaxy-theme-name` in the `package.json` and `valaxy.config.ts` files.
